...
describe('ReplyRepositoryPostgres', () => {
  ...
  describe('addReply function', () => {
    it('should persist new reply and return added reply correctly',
        async () => {
          ...
          const reply = await RepliesTableTestHelper.findReplyById('reply-test-999');
  ...
  describe('deleteReplyById function', () => {
    ...
    it('should delete reply correctly', async () => {
      ...
      await expect(replyRepositoryPostgres.deleteReplyById('reply-test-999'))
          .resolves.not.toThrowError(NotFoundError);

      const deletedReply = await RepliesTableTestHelper
          .findReplyById('reply-test-999');
    ...
    it('should return an empty array when the thread has no comment replies',
        async () => {
          ...
          const result = await replyRepositoryPostgres
              .getRepliesByThreadId('thread-test-999');
